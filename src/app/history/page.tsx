          ...
          {user && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant='outline'
                  className='rounded-full bg-white border-gray-50 hover:bg-gray-50 flex items-center hover:cursor-pointer'>
                  {filter === 'generated' ? 'Generated by me' : 'All summaries'}
                  <ChevronDown className='ml-2 h-4 w-4' />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent className='bg-white rounded-lg shadow-lg py-2 z-[200]'>
                <DropdownMenuItem
