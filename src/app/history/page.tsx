      ...
      <div className='max-w-7xl mx-auto px-6 py-8'>
        <div className='relative'>
          ...
          <div className='flex justify-between items-center mb-8 relative z-10'>
            ...
            <Suspense fallback={<div className='rounded-full dark:bg-gray-900 bg-gray-100 dark:border-gray-800 border-gray-300 px-4 py-2 dark:text-gray-300 text-gray-700'>
