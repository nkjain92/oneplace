...
export default async function HistoryPage({ searchParams }: HistoryPageProps) {
  ...
  // We don't need to fetch subscriptions again here since each SummaryCard
  // will handle subscription status through the client-side store
  // This eliminates the duplicate subscription fetch
      ...
      <div className='max-w-7xl mx-auto px-6 py-8'>
        <div className='relative'>
          ...
          <div className='flex justify-between items-center mb-8 relative z-10'>
            <h1 className='text-2xl font-bold dark:text-white text-gray-900'>Your History</h1>

            {/* Client-side filter component */}
            <Suspense
              fallback={
                <div className='rounded-full dark:bg-gray-900 bg-gray-100 dark:border-gray-800 border-gray-300 px-4 py-2 dark:text-gray-300 text-gray-700'>
              ...
              <HistoryFilter
                ...
                userId={user?.id}
                filter={resolvedSearchParams?.filter as FilterType}
              />
            </Suspense>
          </div>
          ...
          <div className='grid grid-cols-1 gap-6 relative z-10'>
            {!user ? (
              ...
              <div className='dark:bg-gray-900/50 bg-white border dark:border-gray-800/50 border-gray-200/80 rounded-lg shadow-sm p-8 text-center backdrop-blur-sm'>
                <div className='flex flex-col items-center gap-4'>
                  ...
                  <h3 className='text-xl font-semibold dark:text-white text-gray-800'>
                    No summaries in your history yet
                  </h3>
                  <p className='dark:text-gray-400 text-gray-600 max-w-md'>
                    {filterType === 'generated'
                      ...
                      : 'Browse your summary history once you have created some.'}
                  </p>
                </div>
              </div>
            )}
